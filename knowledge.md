**Contact:** +918423069420 | somesh13shukla@gmail.com
...
- Visual RAG for Customer Document Intelligence (Oct 2025 – Present)
  * Converted documents to images, used Vertex AI multimodal embeddings + FAISS for visual similarity search, and injected structured JSON schemas to enable accurate extraction of customer data patterns and insights.
  * Combined spatial OCR with bounding-box reasoning to eliminate hallucinations; delivered production-ready POC for high-volume unstructured document processing and personalized analytics.
